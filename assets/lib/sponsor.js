...
ad.globalAd.call(function (err, result) {
	...
	$( "#current" ).html('<img src="' + clean(result[0]) + '" height="30" width="30"> ' + clean(result[1]) + ' <a class="text-success" href="' + clean(result[3]) + '" rel="nofollow" title="Links to an External Advertiser site" target="_blank"> <b>' + clean(result[2]) + '</b></a><div id="beacon_2a55ce0186" style="position: absolute; left: 0px; top: 0px; visibility: hidden;"></div>');
});
